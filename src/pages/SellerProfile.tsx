...
export default function SellerProfile() {
  ...
  const testNotificationType = async (type: string, testFunction: () => Promise<{ success: boolean; message: string; messageId?: string }>) => {
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Button
                    onClick={() => testNotificationType('Account Approved', () =>
                      sendAccountApprovedNotification({
                        sellerId: seller!.id,
                        sellerName: seller!.business_name || 'Test Seller',
                        email: seller!.email,
