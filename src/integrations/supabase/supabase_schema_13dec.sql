...
CREATE TABLE public.seller_product_listings (
  ...
  status character varying DEFAULT 'draft'::character varying CHECK (status::text = ANY (ARRAY['draft'::character varying::text, 'active'::character varying::text, 'inactive'::character varying::text, 'suspended'::character varying::text, 'pending_approval'::character varying::text, 'failed_approval'::character varying::text])),
  is_verified boolean DEFAULT false,
